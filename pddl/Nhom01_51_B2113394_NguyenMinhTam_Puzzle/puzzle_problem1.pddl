...
(:domain strips-sliding-tile)
    ...
    (:init 
        ...
        (position x1) (position x2) (position x3) (position y1) (position y2) (position y3)
    ...
    (:goal
        (and (at t1 x2 y1) (at t2 x3 y1) (at t3 x1 y2) (at t4 x2 y2) (at t5 x3 y2) (at t6 x1 y3) (at t7 x2 y3) (at t8 x3 y3))
    )
)